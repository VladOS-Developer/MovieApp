...
extension Movie {
    static func mockTopRatedMovie() -> [Movie] {
        return [
            Movie(id: 1, title: "Avatar", originalTitle: "The Way of Water",posterPath: "film1", backdropPath: "dark_knight_backdrop.jpg",
                  overview: "", releaseDate: "2008-07-18",genreIDs: [28, 80, 18], voteAverage: 8, isLocalImage: true),
            
            Movie(id: 2, title: "Avengers", originalTitle: "Infinity War",posterPath: "film2", backdropPath: "dark_knight_backdrop.jpg",
                  overview: "", releaseDate: "2008-07-18",genreIDs: [28, 80, 18], voteAverage: 7.4, isLocalImage: true),
            
            Movie(id: 3, title: "The Dark Knight", originalTitle: "Batman raises the stakes",posterPath: "film3", backdropPath: "dark_knight_backdrop.jpg",
    ...
    static func mockUpcomingMovie() -> [Movie] {
        return [
            ...
            Movie(id: 5, title: "Matrix: Reloaded", originalTitle: "Matrix: Reloaded",posterPath: "film4", backdropPath: "",
            ...
            Movie(id: 6, title: "Dune: Part Two", originalTitle: "Dune: Part Two",posterPath: "film5", backdropPath: "",
