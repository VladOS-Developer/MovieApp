...
- MVP-архітектура з пошаровим поділом Data / Domain / Presentation, пасивним UI, навігацією через Router та Builder як composition root.

- **Data layer** — мережевий шар та репозиторії.  
  NetworkService відповідає виключно за HTTP-запити та декодування даних.  
  Repository інкапсулює джерела даних і виконує мапінг DTO → Domain.

- **Domain layer** — бізнес-сутності та моделі, незалежні від UIKit та мережевого шару.  
  Domain-моделі створюються шляхом мапінгу DTO у стабільні доменні сутності.

- **Presentation layer** — UIKit-представлення та ViewController з пасивним UI.  
  Уся presentation-логіка зосереджена в Presenter. Навігація винесена в Router.
